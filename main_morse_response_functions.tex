...
\begin{document}
 ...
 \end{equation}
	...
	In this appendinx, explicit expressions are presented for derivatives of quantities entering the equation of state, with respect to temperature. This expressions are useful while calculating the response functions in Section~\ref{sec:respons_functions}.
