...
\begin{document}
	...
	\end{equation}
	The quantity $\bar{n}$, on the one hand, has the meaning of the reduced particle number density. On the other hand, it is the average number of particles per cell.
