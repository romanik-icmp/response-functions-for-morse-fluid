...
\begin{document}
	...
	Since $p$ is independent of temperature, the coefficients $g_n$ are also independent of temperature. The quantity $\tilde D(0)$ entering equations~\eqref{eq:eos} and~\eqref{chem_pot} is a function of temperature
	\begin{equation}
