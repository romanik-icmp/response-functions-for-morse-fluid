...
\begin{document}
	...
	\end{equation}
	Note that for all $ \tau> 0 $ the later equation has one real root. Consequently, there are no restrictions on the value of the quantity $ \bar \rho_0 $, which is a function of the temperature and the chemical potential
